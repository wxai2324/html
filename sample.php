...
<div id="ui-header">
    <div class="fixed top-bghead1"><a class="ui-title" id="popmenu1">微信JSSDK接口</a> <a class="ui-btn-left_pre"
                                                                                      href="javascript:;"
                                                                                      onclick="history.go('-1');"></a>
        <a class="ui-btn-right" href="javascript:;" onclick="location.reload();"></a></div>
</div>
